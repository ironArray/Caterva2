...
class Root:
    ...
    def upload(self, localpath, dataset=None):
        ...
        uploadpath = self.client.upload(localpath, dataset)
...
class Client:
    ...
    def get_chunk(self, path, nchunk):
        ...
        Examples
        --------
        >>> client.subscribe('example', urlbase)
        'Ok'
        ...
        >>> info_schunk['cratio']
        6.453000645300064
        >>> chunk = cat2.get_chunk('example/ds-2d-fields.b2nd', 0)
    ...
    def download(self, dataset, localpath=None):
        ...
        **Note:** If the dataset is a regular file and Blosc2 is installed,
        ...
        >>> client.subscribe('example')
        'Ok'
        >>> client.download(pathlib.Path(path))
